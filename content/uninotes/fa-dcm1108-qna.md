...
draft = false
semester = ['S1']
subjectcode = ['FA DCM1108']
unit = 'QNA'
title = 'FA DCM1108 QNA'
toc = true
...
Bookkeeping and accounting are closely related but differ in their scope and purpose. **Bookkeeping** is the process of systematically recording and classifying financial transactions in the books of accounts. **Accounting** is a broader process that uses the data generated by bookkeeping to summarise, analyse, interpret, and communicate financial information to various users for decision-making. Thus, bookkeeping forms the foundation of accounting.  

| **Basis**          | **Bookkeeping**                                    | **Accounting**                                                                                |
| ------------------ | -------------------------------------------------- | --------------------------------------------------------------------------------------------- |
| **Meaning**        | Records and classifies financial transactions.     | Summarises, analyses, interprets, and reports financial information.                          |
| **Nature**         | Mechanical and routine in nature.                  | Analytical and interpretative in nature.                                                      |
| **Scope**          | Narrow; limited to recording transactions.         | Wider; includes preparation and interpretation of financial statements.                       |
| **Objective**      | Maintains systematic and accurate records.         | Determines profit or loss and financial position, and assists in decision-making.             |
| **Stage**          | First stage of the accounting process.             | Second stage, based on bookkeeping records.                                                   |
| **Skill Required** | Requires recording skills and accuracy.            | Requires accounting knowledge, analysis, and professional judgment.                           |
| **Output**         | Journals, ledgers, and other books of account.     | Financial statements, reports, and analysis.                                                  |
| **Users**          | Mainly used by accountants for further processing. | Used by management, owners, creditors, investors, and other stakeholders for decision-making. |

**Conclusion**

Bookkeeping and accounting are complementary activities. Bookkeeping ensures that financial transactions are properly recorded, while accounting converts those records into meaningful financial information. Accurate bookkeeping is essential because effective accounting depends on reliable and systematic financial records. 

**2. Outline the different between accounting standards and IFRS.**

**Ans.**

**Difference Between Accounting Standards and IFRS**

**Accounting Standards (AS)** are authoritative written statements that prescribe principles for the recognition, measurement, presentation, and disclosure of accounting transactions in financial statements. **International Financial Reporting Standards (IFRS)** are globally accepted accounting standards issued by the **International Accounting Standards Board (IASB)** to ensure uniform financial reporting across countries. Both aim to improve the quality and comparability of financial statements, but they differ in their scope and application. 

| **Basis**                  | **Accounting Standards (AS)**                                                                     | **IFRS**                                                                                 |
| -------------------------- | ------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------- |
| **Meaning**                | National accounting standards followed in a particular country.                                   | International accounting standards accepted globally.                                    |
| **Issued by**              | In India, issued by ICAI or notified by the Government through regulatory authorities.            | Issued by the International Accounting Standards Board (IASB).                           |
| **Scope**                  | Mainly applicable within a specific country.                                                      | Applicable across many countries for global financial reporting.                         |
| **Objective**              | Ensures uniformity, reliability, transparency, and comparability in national financial reporting. | Provides a common global accounting language and enhances international comparability.   |
| **Approach**               | May include country-specific rules and legal requirements.                                        | Principles-based approach focusing on the economic substance of transactions.            |
| **Applicability in India** | Traditional Accounting Standards apply as per statutory requirements.                             | India follows **Ind AS**, which are converged with IFRS rather than fully adopting IFRS. |

**Conclusion**

Accounting Standards and IFRS both aim to improve the quality and consistency of financial reporting. However, Accounting Standards are generally national in scope, whereas IFRS provides a globally recognised framework. India has adopted a **convergence approach** through **Indian Accounting Standards (Ind AS)**, aligning with IFRS while making necessary modifications to suit domestic legal and economic conditions.

**3. Discuss with reasons whether the following items are expenditure of capital or revenue nature:**

i) Custom duty paid on import of machinery.  
ii) Wages paid in connection with the erection of a new machinery.  
iii) Rs. 5,000 spent on repainting the factory.  
iv) Repairs for Rs. 2,000 necessitated by negligence of an operator of machine.  
...
**Capital expenditure** is expenditure incurred to acquire or improve a fixed asset and provides benefits over several accounting periods. **Revenue expenditure** is incurred for the day-to-day operations of the business, and its benefit is exhausted within the current accounting period.  

**A) Custom duty paid on import of machinery**

**Capital Expenditure**

Custom duty paid on imported machinery forms part of the **cost of acquiring the machinery**. Since it is incurred to bring the asset into working condition and the benefit extends over many years, it is capitalised and added to the cost of the machinery. 

**B) Wages paid in connection with the erection of a new machinery**

**Capital Expenditure**

Wages paid for installing or erecting a new machine are directly related to making the asset ready for use. Therefore, such wages are added to the cost of the machinery and treated as capital expenditure.  

**C) Rs. 5,000 spent on repainting the factory**

**Revenue Expenditure**

Repainting is a routine maintenance expense incurred to preserve the existing condition of the factory. It neither creates a new asset nor increases the factory's useful life or capacity. Hence, it is a revenue expenditure. 

**D) Repairs for Rs. 2,000 necessitated by negligence of an operator of machine**

**Revenue Expenditure**

These repairs are incurred to restore the machine to its normal working condition. As they do not improve the machine's capacity or extend its useful life, they are treated as revenue expenditure. 

**E) Rs. 10,000 paid for electricity bill**

**Revenue Expenditure**

Electricity charges are recurring operating expenses incurred in the normal course of business. Their benefit is consumed within the current accounting period, so they are charged to the Profit and Loss Account as revenue expenditure. 

**Conclusion**

Thus, **(i) and (ii)** are **Capital Expenditure**, while **(iii), (iv), and (v)** are **Revenue Expenditure**, based on whether the expenditure creates long-term benefits or relates to the routine operations of the business.

**4. Identify the mistake and correct the Trial Balance:**

| Debit Balance | Amount | Credit Balance | Amount |
|---------------|-------:|----------------|-------:|
| Opening Stock | 1,02,600 | Debtors | 45,000 |
| Returns Outwards | 48,000 | Carriage Outwards | 15,000 |
...
In a Trial Balance, **assets and expenses** should appear on the **debit side**, while **capital, liabilities, and incomes** should appear on the **credit side**. The given Trial Balance contains several accounts placed on the wrong side.

**Mistakes Identified:**

* Debtors wrongly shown on the **credit side** → should be **debit**.
* Carriage Outwards wrongly shown on the **credit side** → should be **debit**.
* Machinery wrongly shown on the **credit side** → should be **debit**.
* Trade Expenses wrongly shown on the **credit side** → should be **debit**.
* Creditors wrongly shown on the **debit side** → should be **credit**.
* Rent Received wrongly shown on the **debit side** → should be **credit**.
* Bills Payable wrongly shown on the **debit side** → should be **credit**.
* Building wrongly shown on the **credit side** → should be **debit**.
* Returns Outwards, Discount Received, Sales and Capital are correctly placed on the credit side, while Opening Stock, Salaries, Bank, Carriage Inwards, Discount Allowed and Purchases are correctly placed on the debit side. 

**Corrected Trial Balance**

| **Debit Balance** |        **₹** | **Credit Balance** |        **₹** |
| ----------------- | -----------: | ------------------ | -----------: |
| Opening Stock     |     1,02,600 | Capital            |     1,65,600 |
| Debtors           |       45,000 | Creditors          |       84,000 |
| Bank              |     1,35,000 | Bills Payable      |       60,000 |
| Purchases         |     3,00,000 | Sales              |     4,20,000 |
| Carriage Inwards  |       18,000 | Returns Outwards   |       48,000 |
| Carriage Outwards |       15,000 | Discount Received  |       12,000 |
| Salaries          |       36,000 | Rent Received      |        9,000 |
| Discount Allowed  |        6,000 |                    |              |
| Machinery         |       54,000 |                    |              |
| Building          |       60,000 |                    |              |
| Trade Expenses    |       18,000 |                    |              |
| Return Inward     |        9,000 |                    |              |
| **Total**         | **7,98,600** | **Total**          | **7,98,600** |

**Conclusion**

After placing all accounts on their correct sides according to their nature, the Trial Balance totals **₹7,98,600** on both the debit and credit sides, indicating arithmetical accuracy.

### Questions from Previous Year Question Papers 10 Marks

**1. Define accounts. Discuss the various types of accounts with the help of debit & credit rules of journal.

**Ans.**

**Accounts and Their Types with Debit and Credit Rules of Journal**

An **account** is a systematic record maintained in the ledger to classify and summarise the financial transactions relating to a particular asset, liability, capital, income, or expense. It helps ascertain the balance of each item and forms the basis for preparing the Trial Balance and final accounts. Under the **double-entry system**, every transaction affects at least two accounts—one is debited and the other is credited—thereby maintaining the equality of debits and credits.  

**A) Personal Accounts:**

Personal accounts relate to **individuals, firms, companies, banks, and other institutions**. They record transactions with persons or organisations.
...
Here, Rahul receives the goods; therefore, his account is debited. 

**B) Real Accounts:**

Real accounts represent **tangible and intangible assets**, such as Cash, Machinery, Furniture, Building, Patents, and Goodwill.
...
Nominal accounts relate to **expenses, losses, incomes, and gains**, such as Salary, Rent, Commission, Interest, and Discount.
...
**D) Importance of Debit and Credit Rules:**

The traditional classification of Personal, Real, and Nominal Accounts provides a simple method for applying journal rules. Correct application of these rules ensures that every transaction is recorded accurately and that the accounting equation remains balanced. Modern accounting systems classify accounts as **Assets, Liabilities, Capital, Revenue, and Expenses**, but they continue to follow the same principle of double-entry bookkeeping. 

**Conclusion**

Accounts are the foundation of the accounting system because they record and classify business transactions systematically. Understanding the three traditional types of accounts and their debit and credit rules is essential for accurate journalising, posting to the ledger, and preparing financial statements.

**2. Examine whether the following statements are True or False with reasons:**

i) "Accounting records transactions and events that can be measured in monetary terms" is a limitation of accounting.  
ii) Accounting may be influenced by personal judgement.  
iii) Financial statements are not comparable.  
iv) Accounting information must be presented in such a way that only accounting people understand it.  
v) Accounting aims to communicate financial information to investors only.  

**Ans.**

**True/False with Reasons**

The following statements are examined based on the principles, objectives, and limitations of accounting.

**A) "Accounting records transactions and events that can be measured in monetary terms" is a limitation of accounting.**

**True.** Accounting records only those transactions that can be expressed in monetary terms. Non-financial factors such as employee morale, customer satisfaction, or management quality are not recorded, even though they may significantly affect business performance. Therefore, this is considered a limitation of accounting.  

**B) Accounting may be influenced by personal judgement.**

**True.** Many accounting figures are based on estimates and professional judgement, such as depreciation, provisions for doubtful debts, and valuation of inventory. As a result, accounting information may contain a degree of subjectivity and may not always be completely objective. 

**C) Financial statements are not comparable.**

**False.** One of the important objectives of accounting principles and accounting standards is to make financial statements **comparable** across different enterprises and accounting periods. Comparability enables users to analyse financial performance and make informed decisions.  

**D) Accounting information must be presented in such a way that only accounting people understand it.**

**False.** Accounting information should be **understandable** to all users of financial statements, including investors, creditors, managers, government agencies, and other stakeholders. Clear and understandable presentation improves the usefulness of financial information. 

**E) Accounting aims to communicate financial information to investors only.**

**False.** The objective of accounting is to communicate financial information to **various users**, including management, owners, employees, investors, creditors, government agencies, customers, and the public. Therefore, accounting serves a wide range of stakeholders, not investors alone. 

**Conclusion**

Among the five statements, **(i)** and **(ii)** are **True**, while **(iii)**, **(iv)**, and **(v)** are **False**. These conclusions are based on the objectives, limitations, and qualitative characteristics of accounting information presented in the prescribed study material.

**3. Record the following transactions in the Journal of Ashok and post them into the ledger for the month of April 2024:**

| Date (April 2024) | Transaction |
|-------------------|-------------|
| 1 | Ashok started business with cash Rs. 2,00,000. |
| 2 | Purchased goods for Rs. 50,000 cash. |
| 5 | Purchased furniture for cash Rs. 40,000. |
| 10 | Received Rs. 2,900 from Deepak in full settlement of his account for Rs. 3,000. |
| 12 | Goods costing Rs. 5,000 were given as charity. |
| 15 | Cash withdrawn for personal use Rs. 2,000. |
| 20 | Sold goods to Ajay for cash Rs. 10,000. |
| 21 | Ajay returned goods worth Rs. 2,000. |
| 24 | Paid Rs. 5,000 rent and Rs. 10,000 salary. |
| 30 | Salary outstanding Rs. 2,000. |

**Ans.**

**Journal Entries of Ashok**
...
| Apr. 2  | Purchases A/c Dr.                                        |      |    50,000 |            |
|         | To Cash A/c                                              |      |           |     50,000 |
|         | *(Being goods purchased for cash)*                       |      |           |            |
| Apr. 5  | Furniture A/c Dr.                                        |      |    40,000 |            |
|         | To Cash A/c                                              |      |           |     40,000 |
|         | *(Being furniture purchased for cash)*                   |      |           |            |
| Apr. 10 | Cash A/c Dr.                                             |      |     2,900 |            |
|         | Discount Allowed A/c Dr.                                 |      |       100 |            |
|         | To Deepak A/c                                            |      |           |      3,000 |
|         | *(Being amount received from Deepak in full settlement)* |      |           |            |
| Apr. 12 | Charity A/c Dr.                                          |      |     5,000 |            |
|         | To Purchases A/c                                         |      |           |      5,000 |
|         | *(Being goods given as charity)*                         |      |           |            |
| Apr. 15 | Drawings A/c Dr.                                         |      |     2,000 |            |
|         | To Cash A/c                                              |      |           |      2,000 |
|         | *(Being cash withdrawn for personal use)*                |      |           |            |
| Apr. 20 | Cash A/c Dr.                                             |      |    10,000 |            |
|         | To Sales A/c                                             |      |           |     10,000 |
|         | *(Being goods sold for cash)*                            |      |           |            |
| Apr. 21 | Sales Return A/c Dr.                                     |      |     2,000 |            |
|         | To Cash A/c                                              |      |           |      2,000 |
|         | *(Being goods returned by Ajay and cash refunded)*       |      |           |            |
| Apr. 24 | Rent A/c Dr.                                             |      |     5,000 |            |
|         | Salary A/c Dr.                                           |      |    10,000 |            |
|         | To Cash A/c                                              |      |           |     15,000 |
|         | *(Being rent and salary paid in cash)*                   |      |           |            |
| Apr. 30 | Salary A/c Dr.                                           |      |     2,000 |            |
|         | To Outstanding Salary A/c                                |      |           |      2,000 |
|         | *(Being salary outstanding at month-end)*                |      |           |            |
...
| Dr.             |            ₹ | Cr.          |            ₹ |
| --------------- | -----------: | ------------ | -----------: |
| Capital         |     2,00,000 | Purchases    |       50,000 |
| Deepak          |        2,900 | Furniture    |       40,000 |
| Sales           |       10,000 | Drawings     |        2,000 |
|                 |              | Sales Return |        2,000 |
|                 |              | Rent         |        5,000 |
|                 |              | Salary       |       10,000 |
| **Balance c/d** | **1,03,900** |              |              |
| **Total**       | **2,12,900** | **Total**    | **2,12,900** |
...
**Note:** The question states that **Deepak owed ₹3,000 before 10 April**, so his account is treated as having an opening debit balance of ₹3,000, which is settled by receiving ₹2,900 in cash and allowing a discount of ₹100.

**4. From the following trial balance of Ashok Kumar, you are required to prepare Trading & Profit & Loss A/c for the year ended 31st March 2023 and a Balance Sheet as at that date:**
...
| Bills Receivable & Bills Payable | 10,000 | 8,000 |
| Commission | | 1,500 |
...
iii. Insurance premium is paid for the year ending 30th June 2023.  
iv. Wages have been paid up to 30th June 2023.  
v. Provision for bad debts is to be maintained at 5% on debtors.  
vi. Stock on 31st March 2023 was valued at Rs. 19,400.

**Ans.**

**Trading Account, Profit & Loss Account and Balance Sheet**

The following accounts are prepared from the given Trial Balance and adjustments. The calculations are based strictly on the figures provided.

**Working Notes:**

* Net Sales = ₹1,16,000 − ₹1,000 = **₹1,15,000**
* Net Purchases = ₹60,000 − ₹2,000 = **₹58,000**
* Closing Stock = **₹19,400**
* Furniture Depreciation = 5% of ₹20,000 = **₹1,000**
* Computer Depreciation = 10% of ₹10,000 = **₹1,000**
* Outstanding Salary = **₹1,200**
* Prepaid Insurance = ₹2,000 × 3/12 = **₹500**
* Prepaid Wages = ₹6,000 × 3/12 = **₹1,500**
* New Provision for Bad Debts = 5% of ₹24,000 = **₹1,200**
* Increase in Provision = ₹1,200 − ₹1,000 = **₹200**
...
| **Dr. Particulars** |        **₹** | **Cr. Particulars** |        **₹** |
| ------------------- | -----------: | ------------------- | -----------: |
| To Opening Stock    |       16,700 | By Net Sales        |     1,15,000 |
| To Net Purchases    |       58,000 | By Closing Stock    |       19,400 |
| To Carriage Inwards |        5,000 |                     |              |
| To Wages            |        6,000 |                     |              |
| Less: Prepaid Wages |      (1,500) |                     |              |
| Adjusted Wages      |        4,500 |                     |              |
...
| **Dr. Particulars**                      |      **₹** | **Cr. Particulars**  |      **₹** |
| ---------------------------------------- | ---------: | -------------------- | ---------: |
| To Salaries                              |     12,000 | By Gross Profit b/d  |     50,200 |
| Add: Outstanding                         |      1,200 | By Discount Received |      2,600 |
| Adjusted Salaries                        |     13,200 | By Commission        |      1,500 |
| To Rent                                  |      8,000 |                      |            |
| To Carriage Outward                      |      4,500 |                      |            |
| To Advertising                           |      4,500 |                      |            |
| To Bad Debts                             |        600 |                      |            |
| To Increase in Provision                 |        200 |                      |            |
| To Interest on Loan                      |        300 |                      |            |
| To Fire Insurance                        |      1,500 |                      |            |
| To Depreciation on Furniture             |      1,000 |                      |            |
| To Depreciation on Computer              |      1,000 |                      |            |
| To Net Profit transferred to Capital A/c | **20,500** |                      |            |
| **Total**                                | **55,300** | **Total**            | **55,300** |
...
| **Liabilities**      |      **₹** | **Assets**                    |      **₹** |
| -------------------- | ---------: | ----------------------------- | ---------: |
| Capital              |     50,000 | Cash                          |      3,000 |
| Add: Net Profit      |     20,500 | Bank                          |      7,500 |
|                      |     70,500 | Debtors                       |     24,000 |
| Less: Drawings       |   (10,000) | Less: Provision for Bad Debts |    (1,200) |
| **Adjusted Capital** | **60,500** | **Net Debtors**               | **22,800** |
| 6% Loan              |     10,000 | Bills Receivable              |     10,000 |
| Creditors            |     16,000 | Closing Stock                 |     19,400 |
| Bills Payable        |      8,000 | Furniture                     |     20,000 |
| Outstanding Salaries |      1,200 | Less: Depreciation            |    (1,000) |
|                      |            | **Furniture (Net)**           | **19,000** |
|                      |            | Computer                      |     10,000 |
|                      |            | Less: Depreciation            |    (1,000) |
|                      |            | **Computer (Net)**            |  **9,000** |
|                      |            | Prepaid Insurance             |        500 |
|                      |            | Prepaid Wages                 |      1,500 |
| **Total**            | **95,700** | **Total**                     | **92,700** |

**Conclusion**

Using the figures exactly as provided, the **Trading Account** shows a **Gross Profit of ₹50,200**, and the **Profit & Loss Account** shows a **Net Profit of ₹20,500**. However, the **Balance Sheet does not tally**, showing **Liabilities = ₹95,700** and **Assets = ₹92,700**, a difference of **₹3,000**. This indicates that there is likely an error or omission in the question itself.

**5. Prepare a Trial Balance from the following balances on 31st March 2023.**

| Particulars | Amount (Rs.) | Particulars | Amount (Rs.) |
|-------------|-------------:|-------------|-------------:|
| Cash in Hand | 4,200 | Capital | 50,000 |
| Cash at Bank | 16,800 | Drawings | 18,000 |
| Bills Receivable | 18,000 | Sales | 1,05,000 |
| Bills Payable | 16,000 | Purchases | 75,000 |
| Sundry Debtors | 24,600 | Carriage Inward | 2,700 |
| Sundry Creditors | 32,400 | Salaries | 12,000 |
| Advertisement | 2,400 | Furniture | 7,500 |
| Insurance | 1,600 | Stock | 18,600 |
| Office Rent | 2,000 | | |

**Ans.**

**Preparation of Trial Balance as on 31st March 2023**

A **Trial Balance** is a statement prepared to verify the arithmetical accuracy of the ledger accounts. It contains the closing balances of all ledger accounts, with debit balances shown in the debit column and credit balances shown in the credit column. If the books have been correctly maintained under the double-entry system, the total of the debit column will equal the total of the credit column. 

**A) Classification of Balances:**

* **Debit Balances:** Cash in Hand, Cash at Bank, Bills Receivable, Sundry Debtors, Drawings, Purchases, Carriage Inward, Salaries, Advertisement, Insurance, Office Rent, Furniture, and Opening Stock.
* **Credit Balances:** Capital, Bills Payable, Sundry Creditors, and Sales.

---

**Trial Balance of the Business as on 31st March 2023**
...
Total Debit Balances = **₹2,03,400**

Total Credit Balances = **₹2,03,400**

Since both totals are equal, the Trial Balance **agrees**, indicating that the ledger postings are **arithmetically correct**. However, this does not guarantee that all accounting errors have been eliminated, as some errors (such as errors of omission, principle, or compensating errors) may still exist. 

**Conclusion**

The Trial Balance has been correctly prepared with **equal debit and credit totals of ₹2,03,400**. It provides a summary of all ledger balances and serves as the basis for preparing the Trading Account, Profit and Loss Account, and Balance Sheet.

**6. Journalize the following transactions and prepare the ledger only of the 'Cash Account'.**

a) Bought goods from Mohan of the list price of Rs. 10,000 at 15% Trade Discount.  
b) Settled the account of Mohan by paying cash, under a discount of 4%.  
c) Bought goods for cash of the list price of Rs. 50,000 at 20% Trade Discount and 5% Cash Discount.  
d) Sold goods for cash of the list price of Rs. 20,000 @ 10% Trade Discount and 3% Cash Discount.

**Ans.**

Trade discount is not recorded in the books of accounts because it is deducted before recording the transaction. Only the net invoice price is entered in the Journal. Cash discount, however, is recorded as it represents a financial gain or loss at the time of payment or receipt.

**Journal Entries:**

| Date | Particulars                                                                          | L.F. | Debit (Rs.) | Credit (Rs.) |
| ---- | ------------------------------------------------------------------------------------ | ---- | ----------: | -----------: |
| (a)  | Purchases A/c Dr.                                                                    |      |       8,500 |              |
|      | To Mohan A/c                                                                         |      |             |        8,500 |
|      | *(Being goods purchased from Mohan after 15% trade discount)*                        |      |             |              |
| (b)  | Mohan A/c Dr.                                                                        |      |       8,500 |              |
|      | To Cash A/c                                                                          |      |             |        8,160 |
|      | To Discount Received A/c                                                             |      |             |          340 |
|      | *(Being payment made to Mohan after receiving 4% cash discount)*                     |      |             |              |
| (c)  | Purchases A/c Dr.                                                                    |      |      40,000 |              |
|      | To Cash A/c                                                                          |      |             |       38,000 |
|      | To Discount Received A/c                                                             |      |             |        2,000 |
|      | *(Being goods purchased for cash after 20% trade discount and 5% cash discount)*     |      |             |              |
| (d)  | Cash A/c Dr.                                                                         |      |      17,460 |              |
|      | Discount Allowed A/c Dr.                                                             |      |         540 |              |
|      | To Sales A/c                                                                         |      |             |       18,000 |
|      | *(Being goods sold for cash after allowing 10% trade discount and 3% cash discount)* |      |             |              |

**Cash Account:**

| **Dr.**      |    **Rs.** | **Cr.**          |    **Rs.** |
| ------------ | ---------: | ---------------- | ---------: |
| To Sales A/c |     17,460 | By Mohan A/c     |      8,160 |
|              |            | By Purchases A/c |     38,000 |
|              |            | By Balance c/d*  |     28,700 |
| **Total**    | **46,160** | **Total**        | **46,160** |

*The question does not provide an opening cash balance. Therefore, to balance the Cash Account, an opening balance of **Rs. 28,700** is implied. If no opening balance is assumed, the Cash Account will show a **credit balance (cash deficiency/overdraft) of Rs. 28,700** instead of a normal debit balance.

**Conclusion**

The journal entries have been passed after correctly accounting for trade and cash discounts. Trade discount has been excluded from the books, while cash discount has been recorded. The Cash Account reflects only cash receipts and cash payments arising from the given transactions.

**7. Prepare a Trial Balance from the following balances of Shri Gopi Chand as on 31st March 2024.**
...
| Purchase Return | 5,000 | Debtors | 36,000 |
| Sales | 1,60,000 | Creditors | 12,750 |
| Sales Return | 6,200 | Bills Receivables | 4,600 |
| Rent | 1,200 | Bills Payable | 2,500 |
| Salaries | 5,700 | Cash in Hand | 5,220 |
| Advertisement | 880 | Bank Overdraft | 10,000 |
| Commission Received | 1,440 | Interest on Overdraft | 1,800 |
| Discount (Cr.) | 710 | Capital | 50,000 |
| | | Drawings | 7,800 |

**Ans.**

**Trial Balance of Shri Gopi Chand as on 31st March 2024**

A **Trial Balance** is a statement that lists all ledger account balances on a particular date to verify the arithmetical accuracy of the books of accounts. Debit balances are recorded in the debit column, while credit balances are recorded in the credit column.
...
| Drawings              |           7,800 |                  |
| Capital               |                 |           50,000 |
| **Total**             |    **2,42,400** |     **2,42,400** |

**Conclusion**

The Trial Balance has been prepared by placing all assets, expenses, purchases, and drawings on the debit side, and capital, liabilities, incomes, sales, and returns outward on the credit side. Since the total of both columns is **₹2,42,400**, the Trial Balance agrees, indicating that the ledger postings are arithmetically correct.

**8. Journalize the following transactions:**

| Date | Particulars | Amount (Rs.) |
|------|-------------|-------------:|
| April 1 | X started business with cash | 4,00,000 |
| 2 | Goods purchased for cash | 1,20,000 |
| 5 | Goods purchased from Bhanu | 80,000 |
| 7 | Goods sold for cash | 40,000 |
| 10 | Goods sold to Bharat Kumar | 1,20,000 |
| 15 | Cash received from Bharat Kumar | 1,15,000 |
| | He was allowed discount | 5,000 |
| 17 | Paid Charity | 1,000 |
| 18 | Paid to Bhanu | 39,000 |
| | Received discount from him | 1,000 |
| 25 | Paid Salary | 5,000 |
| | Paid Rent | 4,000 |
| 27 | Deposited into bank | 20,000 |
| 30 | Purchased furniture from Patel and paid by cheque | 15,000 |

**Ans.**

**Journal Entries**

The following transactions are recorded in the Journal according to the rules of double-entry bookkeeping. Cash transactions affect the Cash Account, credit transactions affect the personal accounts of debtors or creditors, and discounts allowed or received are recorded separately.

| Date    | Particulars                                                         | L.F. | Debit (Rs.) | Credit (Rs.) |
| ------- | ------------------------------------------------------------------- | ---- | ----------: | -----------: |
| Apr. 1  | Cash A/c Dr.                                                        |      |    4,00,000 |              |
|         | To Capital A/c                                                      |      |             |     4,00,000 |
|         | *(Being business commenced with cash)*                              |      |             |              |
| Apr. 2  | Purchases A/c Dr.                                                   |      |    1,20,000 |              |
|         | To Cash A/c                                                         |      |             |     1,20,000 |
|         | *(Being goods purchased for cash)*                                  |      |             |              |
| Apr. 5  | Purchases A/c Dr.                                                   |      |      80,000 |              |
|         | To Bhanu A/c                                                        |      |             |       80,000 |
|         | *(Being goods purchased on credit from Bhanu)*                      |      |             |              |
| Apr. 7  | Cash A/c Dr.                                                        |      |      40,000 |              |
|         | To Sales A/c                                                        |      |             |       40,000 |
|         | *(Being goods sold for cash)*                                       |      |             |              |
| Apr. 10 | Bharat Kumar A/c Dr.                                                |      |    1,20,000 |              |
|         | To Sales A/c                                                        |      |             |     1,20,000 |
|         | *(Being goods sold on credit to Bharat Kumar)*                      |      |             |              |
| Apr. 15 | Cash A/c Dr.                                                        |      |    1,15,000 |              |
|         | Discount Allowed A/c Dr.                                            |      |       5,000 |              |
|         | To Bharat Kumar A/c                                                 |      |             |     1,20,000 |
|         | *(Being cash received from Bharat Kumar in full settlement)*        |      |             |              |
| Apr. 17 | Charity A/c Dr.                                                     |      |       1,000 |              |
|         | To Cash A/c                                                         |      |             |        1,000 |
|         | *(Being charity paid in cash)*                                      |      |             |              |
| Apr. 18 | Bhanu A/c Dr.                                                       |      |      40,000 |              |
|         | To Cash A/c                                                         |      |             |       39,000 |
|         | To Discount Received A/c                                            |      |             |        1,000 |
|         | *(Being payment made to Bhanu after receiving discount)*            |      |             |              |
| Apr. 25 | Salary A/c Dr.                                                      |      |       5,000 |              |
|         | Rent A/c Dr.                                                        |      |       4,000 |              |
|         | To Cash A/c                                                         |      |             |        9,000 |
|         | *(Being salary and rent paid in cash)*                              |      |             |              |
| Apr. 27 | Bank A/c Dr.                                                        |      |      20,000 |              |
|         | To Cash A/c                                                         |      |             |       20,000 |
|         | *(Being cash deposited into bank)*                                  |      |             |              |
| Apr. 30 | Furniture A/c Dr.                                                   |      |      15,000 |              |
|         | To Bank A/c                                                         |      |             |       15,000 |
|         | *(Being furniture purchased from Patel and payment made by cheque)* |      |             |              |

**Conclusion**

The above journal entries correctly record all the business transactions for April by applying the rules of debit and credit. Cash, bank, purchases, sales, discounts, expenses, and personal accounts have been appropriately debited and credited, ensuring that the accounting equation remains balanced after every transaction.
...
**Liabilities** are the obligations or debts payable to outsiders.
**Capital** represents the owner’s investment or claim in the business.
...
**Example:** If goods are purchased from Ram on credit, Ram’s account is credited because he is the giver.
...
**4. Describe the role of source documents and vouchers in recording financial transactions.
Explain why they are essential for accuracy.**
...
When a business purchases goods from a supplier, the supplier’s invoice acts as the source document. Based on this invoice, an accounting voucher is prepared, and the transaction is recorded in the books of accounts.
...
A debit note is issued by the buyer to the supplier when goods are returned. It informs the supplier that the supplier’s account is being debited in the buyer’s books.
...
Each subsidiary book maintains complete details of specific transactions. For example, the Purchase Book contains information such as date, supplier’s name, invoice number, details of goods, and amount.
...
The Debtors Ledger helps determine the amount receivable from each customer at any point in time by showing the closing balance of every debtor’s account.
...
Each supplier’s account records credit purchases, payments made, purchase returns, and outstanding balances payable to suppliers.
...
It may contain accounts relating to capital, drawings, salaries of key personnel, and proprietor’s personal expenses.
...
**5. The following are the transactions for Crimston Software Ltd (CSL). Pass journal entries and
check the solution suing ledger accounts.**
